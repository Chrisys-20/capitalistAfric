...
<body>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown-v" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="{{asset('dashboard/assets/images/users/homme.png')}}" alt="Header Avatar">
    ...
    <!-- <script type="text/javascript">
        function confirmation(ev) {
            ...
            ev.preventDefault();
            var urlToredirect = ev.curenntTarget.getAttribute('href');
